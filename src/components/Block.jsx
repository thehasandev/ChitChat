...
import c1 from "../assets/b1.png"

function Block() {
  return (
    <div className='w-[384px] h-[505px] p-5 bg-white shadow-lg rounded-[10px] m-5'>
     <h2 className='flex font-inter font-semibold text-2xl text-secondary justify-between items-center'>Block List <span><BsThreeDotsVertical/></span></h2>
      ...
      <div className='mt-6 overflow-y-scroll box h-[368px] pr-4 '>
          <Flex className="justify-between items-center mb-4">
            <Flex className="items-center gap-x-4">
              ...
              <div>
                <h2 className='font-inter font-semibold text-lg text-secondary'>Paula Mora</h2>
              </div>
            </Flex>
            <div>
              <div>
                <button className='font-inter font-medium text-sm px-2 py-1  text-secondary rounded-[2px]'>Unblock</button>
              </div>
