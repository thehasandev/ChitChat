    ...
    <div className='h-screen w-full bg-primary/50 flex justify-center items-center'>
      <div className='w-[350px] md:w-96  bg-white py-16 shadow-lg rounded-[10px]'>
         ...
         <div className='w-10/12 mx-auto relative'>
           <input type="email" placeholder='Enter your mail'  className='w-full border border-gray p-3.5 rounded-[5px]'/>
         ...
         <div className='flex justify-center gap-x-4 w-10/12 mx-auto mt-8'>
            <button className='px-4 rounded-[5px] bg-primary py-3 text-white font-inter font-medium text-base '>Reset</button>
            <Link to="/">
